...
/obj/item/rig/light
	...
	emp_protection = 100
	slowdown = -1
	species_restricted = list(BODYTYPE_HUMAN, BODYTYPE_UNATHI, BODYTYPE_SKRELL, BODYTYPE_VAURCA_WORKER, BODYTYPE_VAURCA_WARRIOR)
...
/obj/item/rig/light/ninja
	...
	species_restricted = list(BODYTYPE_HUMAN,BODYTYPE_TAJARA,BODYTYPE_UNATHI, BODYTYPE_SKRELL, BODYTYPE_IPC, BODYTYPE_VAURCA_WORKER, BODYTYPE_VAURCA_WARRIOR)

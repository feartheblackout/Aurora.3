...
/obj/item/clothing/gloves
	...
	species_restricted = list("exclude",BODYTYPE_UNATHI,BODYTYPE_TAJARA,BODYTYPE_VAURCA_WORKER,BODYTYPE_VAURCA_WARRIOR,BODYTYPE_GOLEM,BODYTYPE_VAURCA_BREEDER,BODYTYPE_VAURCA_WARFORM,BODYTYPE_VAURCA_BULWARK,BODYTYPE_TESLA_BODY)
...
/obj/item/clothing/shoes
	...
	force = 0
	var/overshoes = 0
	species_restricted = list("exclude",BODYTYPE_UNATHI,BODYTYPE_TAJARA,BODYTYPE_VAURCA_WORKER,BODYTYPE_VAURCA_WARRIOR,BODYTYPE_VAURCA_BREEDER,BODYTYPE_VAURCA_WARFORM, BODYTYPE_TESLA_BODY)
	var/silent = 0
	var/last_trip = 0

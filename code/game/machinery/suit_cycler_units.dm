/obj/machinery/suit_cycler/engineering
	...
	species = list(BODYTYPE_HUMAN, BODYTYPE_SKRELL, BODYTYPE_UNATHI, BODYTYPE_TAJARA, BODYTYPE_VAURCA_WORKER, BODYTYPE_VAURCA_WARRIOR, BODYTYPE_IPC)
...
/obj/machinery/suit_cycler/offship //To be set up for various offships
	...
	species = list(BODYTYPE_HUMAN, BODYTYPE_TAJARA, BODYTYPE_IPC, BODYTYPE_SKRELL, BODYTYPE_UNATHI, BODYTYPE_VAURCA_WORKER, BODYTYPE_VAURCA_WARRIOR)
	boots = /obj/item/clothing/shoes/magboots
	mask = /obj/item/clothing/mask/breath
